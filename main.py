...
remove_linha = identificar_gemas_colunas(tabuleiro)
remove_coluna = identificar_gemas_linha(tabuleiro)
p_l,p_c = power_ups(remove_linha,remove_coluna,tabuleiro)
eliminar_gemas(remove_linha,remove_coluna,tabuleiro,p_l,p_c)
